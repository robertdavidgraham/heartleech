...
these bytes may typically be at the start of the TCP payload, they don't have
to be.
...
connection in order to evade the IDS.
...
On the server side, the replies naturally come back together. I havne't tested
anywhere but the CloudFlare challenge server, but I think this should almost
always be the case. It looks for |18 03| as the packet header and warns you
